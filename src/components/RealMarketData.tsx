...
const RealMarketData = () => {
  ...
  return (
    <div className="terminal-panel h-full">
      <div className="panel-header">REAL-TIME MARKET DATA (15min delay)</div>
      <div className="panel-content">
        <div className="grid grid-cols-4 gap-1 text-[9px] font-semibold text-terminal-amber mb-2 pb-1 border-b border-terminal-amber/30">
          <div>SYMBOL</div>
